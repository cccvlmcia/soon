...
export async function editSoonHistory(
  ...
  return await txProcess(async manager => {
    ...
    const {userid, sjid, swid, kind, progress, historydate, contents} = history;
    const historyData = await repository.update({historyid}, {userid, sjid, swid, kind, progress, historydate, contents});
